    ...
    var i = function () {
        new Swiper(".main-swiper", {
            ...
            new Swiper("#" + i + " .swiper", {
                ...
                spaceBetween: 20,
                navigation: {
                    nextEl: "#" + i + " .icon-arrow-right",
                    prevEl: "#" + i + " .icon-arrow-left"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 2,
        ...
        var i = new Swiper(".product-thumbnail-slider", {
            slidesPerView: 3,
            spaceBetween: 20,
            direction: "vertical",
            breakpoints: {
        ...
        n = function () {
            jarallax(document.querySelectorAll(".jarallax")), jarallax(document.querySelectorAll(".jarallax-keep-img"), {
                keepImg: !0
            })
        },
        o = function () {
        ...
        s = function () {
            e(".grid").each(function () {
                ...
                e(".button-group").on("click", "a", function (i) {
                    i.preventDefault(), t = e(this).attr("data-filter"), n.isotope({
                        filter: t
                    })
        ...
        r = function () {
            e(".image-zoom").on("mouseover", function () {
                e(this).children(".photo").css({
                    transform: "scale(" + e(this).attr("data-scale") + ")"
                })
                ...
                e(this).children(".photo").css({
                    "transform-origin": (i.pageX - e(this).offset().left) / e(this).width() * 100 + "% " + (i.pageY - e(this).offset().top) / e(this).height() * 100 + "%"
                })
            }).each(function () {
                e(this).append('<div class="photo"></div>').children(".photo").css({
                    "background-image": "url(" + e(this).attr("data-image") + ")"
                })
            })
        },
        c = function () {
            e(".navbar").on("click", ".search-button", function (i) {
                ...
                i.preventDefault(), e(".search-popup").addClass("is-visible"), setTimeout(function () {
                    e(".search-popup").find("#search-popup").focus()
                }, 350)
            }), e(".search-popup").on("click", function (i) {
                (e(i.target).is(".search-popup-close") || e(i.target).is(".search-popup-close svg") || e(i.target).is(".search-popup-close path") || e(i.target).is(".search-popup")) && (i.preventDefault(), e(this).removeClass("is-visible"))
